package com.brainwashstudio.orm.util;

import com.brainwashstudio.orm.DatabaseFactory;
import com.brainwashstudio.orm.FieldProperty;
import com.brainwashstudio.orm.Property;
import com.brainwashstudio.orm.TypeName;
import com.brainwashstudio.orm.affinity.*;
import com.brainwashstudio.orm.annotation.Ignore;
...
public class TypeUtils {
    ...
    static {
        ...
        TYPE_TO_AFFINITY.put(Boolean.class, NumericAffinity.class);
        // TODO add more later
    }
    ...
    private static void getProperties(DatabaseFactory factory, Class<?> clazz, List<Property> properties, Class<?> topClass) {
        ...
        for(Field field : clazz.getDeclaredFields()) {
            if(isOfInterest(field)) {
                properties.add(new FieldProperty(factory, topClass, field));
            }
        }
    ...
    public static Class<? extends TypeName> affinityFromType(Class<?> type) {
        if(type.isPrimitive()) {
